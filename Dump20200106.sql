CREATE DATABASE  IF NOT EXISTS `qlpk` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `qlpk`;
...
INSERT INTO `benh` VALUES ('B001','Viêm Họng','Đau họng, ho, rát cổ họng'),('B002','Viêm Xoan','Chảy dịch mũi, hắt hơi, nghẹt mũi'),('B003','Ngáy ban đêm','Mất ngủ, ngủ không ngon, mơ nhiều'),('B004','Nấm tai','Ngứa sâu trong tai, cảm giác sưng đầy trong tai'),('B005','Viêm dây thanh','Mất tiếng, nói nhanh mệt, không thể nói lớn, Sủa'),('B006','Viêm dây thanh','Mất tiếng, nói nhanh mệt, không thể nói lớn, Sủa'),('B007','Viêm Xoan','Chảy dịch mũi, hắt hơi, nghẹt mũi'),('B008','fghfgh','fhfgh'),('B009','qeqeqew','qeqwewe');
...
INSERT INTO `benhnhan` VALUES ('BN001','Nguyễn Văn Tý','2002-04-04','Nam','Thanh Hóa','071821842'),('BN002','Nguyễn Văn A','1890-05-02','Nam','Quảng Quải','096145185'),('BN003','Ngô Bá Khá','1994-09-02','Nam','Quảng Ninh','076149136'),('BN004','Nguyễn Thị Thùy Dương','1999-07-12','Nữ','Cần Đước, Long An, Việt Nam','07517583'),('BN005','13123','2019-12-12','Nữ','1312','123123'),('BN006','123123123','2019-12-19','Nam','12312','123123');
...
INSERT INTO `donthuoc` VALUES ('PK001','T001',5,'CD001'),('PK002','T002',13,'CD002'),('PK002','T003',13,'CD003'),('PK002','T004',456,'CD001'),('PK002','T005',2,'CD004'),('PK003','T001',123,'CD001'),('PK003','T004',123,'CD002'),('PK005','T001',1,'CD001'),('PK008','T001',11,'CD001');
...
INSERT INTO `hoadon` VALUES ('HD001','Pk001','2019-07-03',944000,974000),('HD002','PK002','2019-12-28',16897000,16927000),('HD003','pk003','2019-12-30',4674000,4704000),('HD004','pk005','2020-01-06',2000,32000),('HD005','PK008','2020-01-06',22000,52000);
...
INSERT INTO `lichsudangnhap` VALUES ('US001','2019-07-02 20:31:26'),('US002','2019-07-04 02:47:16'),('US001','2019-07-04 07:54:22'),('US001','2019-07-04 08:02:13'),('US001','2019-07-04 08:33:57'),('US001','2019-07-04 11:28:01'),('US001','2019-07-28 18:05:34'),('US001','2019-07-28 18:06:59'),('US001','2019-10-08 10:08:15'),('US001','2019-11-26 12:54:30'),('US001','2019-12-04 10:29:31'),('US001','2019-12-04 10:32:28'),('US001','2019-12-09 14:19:51'),('US001','2019-12-09 14:27:40'),('US001','2019-12-09 14:56:11'),('US001','2019-12-09 14:56:25'),('US001','2019-12-09 14:57:04'),('US001','2019-12-10 21:04:30'),('US001','2019-12-16 09:14:56'),('US001','2019-12-16 14:26:17'),('US001','2019-12-16 22:34:45'),('US001','2019-12-28 13:19:23'),('US001','2019-12-29 22:42:43'),('US001','2019-12-29 23:36:11'),('US001','2019-12-30 08:22:58'),('US001','2019-12-30 08:24:30'),('US001','2019-12-30 08:29:18'),('US001','2019-12-30 08:30:07'),('US001','2019-12-30 08:30:56'),('US001','2019-12-30 08:31:45'),('US001','2019-12-30 11:59:28'),('US001','2019-12-30 12:17:04'),('US001','2019-12-30 13:15:21'),('US001','2019-12-30 14:15:15'),('US001','2019-12-31 16:38:49'),('US001','2019-12-31 16:42:21'),('US001','2019-12-31 16:48:55'),('US001','2019-12-31 17:28:43'),('US001','2019-12-31 17:32:00'),('US001','2019-12-31 17:52:38'),('US001','2020-01-01 10:01:35'),('US001','2020-01-01 10:13:29'),('US001','2020-01-03 00:00:00'),('US001','2020-01-03 00:00:00'),('US001','2020-01-03 00:00:00'),('US001','2020-01-03 00:00:00'),('US001','2020-01-03 00:00:00'),('US001','2020-01-03 00:00:00'),('US001','2020-01-03 00:00:00'),('US001','2020-01-03 00:00:00'),('US001','2020-01-03 00:00:00'),('US001','2020-01-05 00:00:00'),('US003','2020-01-05 17:12:38'),('US003','2020-01-05 17:15:36'),('US001','2020-01-05 00:00:00'),('US003','2020-01-05 00:00:00'),('US001','2020-01-05 00:00:00'),('US001','2020-01-05 00:00:00'),('US001','2020-01-05 00:00:00'),('US001','2020-01-05 00:00:00'),('US001','2020-01-05 00:00:00'),('US001','2020-01-05 00:00:00'),('US001','2020-01-05 00:00:00'),('US001','2020-01-05 00:00:00'),('US001','2020-01-06 00:00:00'),('US001','2020-01-06 00:00:00'),('US001','2020-01-06 00:00:00'),('US001','2020-01-06 00:00:00');
...
INSERT INTO `phieukham` VALUES ('PK001','BN003','NV001','B003','2019-07-03','redd','sfgdxfgg'),('PK002','BN001','NV004','B003','2019-07-04','fdxgdfghd','dgfhdgh'),('PK003','BN002','NV005','B005','2019-07-04',NULL,NULL),('PK005','BN002','NV001','B001','2019-12-30',NULL,NULL),('PK006','BN001','NV001','B003','2019-12-31',NULL,NULL),('PK007','BN001','NV003','B001','2019-12-10',NULL,NULL),('PK008','BN001','NV001','B001','2020-01-06','','');
...
INSERT INTO `thuoc` VALUES ('T001','Panadon','DV001','2018-07-02','2019-07-02',2000),('T002','Kháng Sinh','DV002','2018-02-04','2019-02-04',20000),('T003','Paracetamol','DV001','2018-07-02','2019-07-02',17000),('T004','Thuốc Tê','DV002','2018-07-02','2019-07-02',36000),('T005','sdfsdfsdsdf','DV002','2018-02-04','2019-02-05',21324234);
...
INSERT INTO `users` VALUES ('US001','admin','admin','NV001','QH001'),('US002','thuantran','123456','NV005','QH002'),('US003','nhanvien','nhanvien','NV003','QH002');
...
-- Dump completed on 2020-01-06 15:38:44
