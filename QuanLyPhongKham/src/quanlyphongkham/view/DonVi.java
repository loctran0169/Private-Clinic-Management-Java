...
public class DonVi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 161, 700, 340));

        jLabel1.setText("Mã Đơn Vị:");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(11, 33, -1, -1));
        getContentPane().add(txtMaDonVI, new org.netbeans.lib.awtextra.AbsoluteConstraints(81, 30, 170, -1));

        jLabel2.setText("Tên Đơn Vị:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(376, 33, -1, -1));
        ...
        getContentPane().add(txtTenDonVi, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 30, 170, -1));
        ...
        getContentPane().add(btnThem, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 110, 100, 40));
        ...
        getContentPane().add(btnHuy, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 60, 100, 40));
        ...
        getContentPane().add(btnLuu, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 60, 100, 40));
        ...
        getContentPane().add(btnXoa, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 110, 100, 40));
        ...
        getContentPane().add(btnSua, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 110, 100, 40));
        ...
        getContentPane().add(btnLoad, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 110, 120, 40));
