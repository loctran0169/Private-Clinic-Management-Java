...
public class LapPhieuKhamDTO {
    ...
    public LapPhieuKhamDTO() {
    }

    public LapPhieuKhamDTO(String MaPK, String MaBN, String TenBN, Date NgayKham, String MaBS, String TenBS, String MaLB, String TrieuChung, String TenLB) {
        this.MaPK = MaPK;
        this.MaBN = MaBN;
        this.TenBN = TenBN;
